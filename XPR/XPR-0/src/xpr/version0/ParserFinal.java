 ...
 * 
 * Além de testar se a entrada está no formato correto, ela calcula o
 * resultado da expressão algébrica dada como entrada (funcionando como um
...
public class ParserFinal {
	...
	public static void main(String[] args) throws Exception {
		ParserFinal parser = new ParserFinal();
